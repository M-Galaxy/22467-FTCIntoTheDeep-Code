...
@TeleOp(name = "GOTOARM2")

public class GOTOARM2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.a) {
                goodtilt.setPosition(0.8); // Set goodtilt to max position
            }
            if (gamepad2.b) {
                goodtilt.setPosition(1.0); // Set goodtilt to min position
            }
